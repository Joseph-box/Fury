...
BINDING_NAME_FURY_TANKMODE = "Toggle Tank setup"
...
TALENT_EXECUTE_FURY = "Execute Cost"
TALENT_FLURRY_FURY = "Flurry"
TALENT_IMP_BERSERKER_RAGE_FURY = "Improved Berserker Rage"
TALENT_IMP_HAMSTRIG_FURY = "Improved Hamstring"
...
CHAT_INTERRUPT6_FURY = "Your Pummel failed. (.+) is immune."
CHAT_INTERRUPT7_FURY = "Your Shield Bash failed. (.+) is immune."
...
MODE_HEADER_FURY = "Fury"
MODE_HEADER_ARMS = "Arms"
MODE_HEADER_NONE = "No stance"

SLASH_FURY_ATTACKRAGE = "Minimum rage required when using Heroic Strike or Cleave set to dump rage "
SLASH_FURY_AUTOAOE = "Automatic switching between 'single' and 'AoE' attacks is set to "
...
SLASH_FURY_LOWTHREAT = "Threat: OFF (Heroic Strike and Sunder Armor DISABLED)"
SLASH_FURY_HIGHTHREAT = "Threat: ON (Heroic Strike and Sunder Armor ENABLED)"
...
TEXT_FURY_ADDED = "Added "
TEXT_FURY_IMMUNE_TO_DISARM = " to immune disarm list"
TEXT_FURY_IMMUNE_TO_INTERRUPT = " to immune interrupt list"
...
CHAT_MISSING_SPELL_INTIMIDATING_SHOUT = "Missing spell on action bar Intimidating Shout"
CHAT_MISSING_SPELL_PUMMEL_FURY = "Missing spell on action bar (any close combat spell, like Pummel)"

FURY_INTERRUPT_BLACKLIST = { -- better to let cast
	["Blackwing Spellbinder"] = true,
}

Fury_ImmuneInterrupt = { -- immune to interrupts
...
HELP_AUTOAOE = "/fury autoaoe - toggles the automatic switching between 'single' and 'AoE' attacks."
HELP_ABILITY =
...
HELP_SHIELDBASHSWAP =
	"/fury shieldbashswap -- toggles use of swap offhand weapon with a shield when trying to interrupt (Uses Outfitter, Shield Bash)"
...
HELP_FURYDPS = "/fury furydps - toggle default stance"
HELP_ARMSDPS = "/fury armsdps - toggle default stance"
...
HELP_STANCE =
	"/fury stance <1|2|3|name> - sets stance to return to after switching stance. If default is selected it will return to your last used stance. If no stance is selected it will disable stance switching. (Must use correct names with capitalization.)"
