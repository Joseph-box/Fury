...
FURY_INTERRUPT_IMMUNE = { -- immune to interrupts
...
HELP_SHIELDBASHSWAP= "/fury shieldbashswap -- toggles use of swap offhand weapon with a shield when trying to interrupt (Uses Outfitter, Shield Bash)"
